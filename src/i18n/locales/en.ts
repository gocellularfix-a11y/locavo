...
export const en: TranslationCatalog = {
  ...
  'explore.searchGlobalPlaceholder': 'Search coffee, tacos, Walmart…',
  'explore.searchScope': 'Searching all places in this city',
  'explore.emptySearchTitle': 'No places matched',
  'explore.emptySearchBody': 'No places found for “{query}”. Search covers the whole city — try another spelling or keyword.',
  ...
  'decision.section.title': 'For you now',
  ...
  'decision.why.template': 'We recommend it because {list}.',
  'decision.why.fallback': 'We recommend it as a solid option among those available now.',
  'decision.why.openLate': 'it stays open late',
  'decision.why.mealBreakfast': 'it is breakfast time',
  'decision.why.mealLunch': 'it is lunchtime',
  'decision.why.mealDinner': 'it is a good time for dinner',
  'decision.why.morning': 'it is great for the morning',
  'decision.why.weekend': 'it is a good weekend pick',
  'decision.why.intentMatch': 'it matches what you asked for',
  'decision.why.family': 'it is good for families',
  'decision.why.accessible': 'it is accessible',
  'decision.why.parking': 'it has parking',
  'decision.why.verified': 'its information is verified',
  ...
  'place.call': 'Call',
  'place.callA11y': 'Call {name}',
  'place.callHint': 'Opens the phone dialer with the business number',
  'place.websiteHint': 'Opens the business website in the browser',
  'place.actionFailed': "Couldn't open that action. Please try again.",
  'place.action.available': 'Available',
  'place.action.missing': 'No information',
  'place.action.invalidCoords': 'Location not valid for navigation',
  'place.action.invalidPhone': 'Invalid phone number',
  'place.action.invalidUrl': 'Invalid website address',
  'place.action.unsupportedScheme': 'Link not allowed',
  ...
  'distance.fromYourLocation': 'from your location',
  'distance.fromSelected': 'from selected location',
  'distance.fromCityCenter': 'from the city center',
  'distance.from': 'from {location}',
};
