...
export const fr: TranslationCatalog = {
  ...
  'explore.searchGlobalPlaceholder': 'Cherchez café, tacos, Walmart…',
  'explore.searchScope': 'Recherche dans toute la ville',
  'explore.emptySearchTitle': 'Aucun lieu trouvé',
  'explore.emptySearchBody': 'Rien pour « {query} ». La recherche couvre toute la ville — essayez une autre orthographe ou un autre mot.',
  ...
  'search.noNearbyResults': "Il n'y a rien près de vous ; voici les lieux les plus proches, même s'ils sont loin.",
  ...
  'decision.section.title': 'Pour vous maintenant',
  ...
  'decision.why.template': 'Nous le recommandons parce que {list}.',
  'decision.why.fallback': 'Nous le recommandons comme une bonne option parmi celles disponibles.',
  'decision.why.openLate': 'il est ouvert tard',
  'decision.why.mealBreakfast': "c'est l'heure du petit-déjeuner",
  'decision.why.mealLunch': "c'est l'heure du déjeuner",
  'decision.why.mealDinner': "c'est un bon moment pour dîner",
  'decision.why.morning': 'il est idéal le matin',
  'decision.why.weekend': 'il est parfait pour le week-end',
  'decision.why.intentMatch': 'il correspond à ce que vous cherchez',
  'decision.why.family': 'il convient aux familles',
  'decision.why.accessible': 'il est accessible',
  'decision.why.parking': 'il dispose d’un parking',
  'decision.why.verified': 'ses informations sont vérifiées',
  ...
  'distance.fromCityCenter': "depuis le centre-ville",
