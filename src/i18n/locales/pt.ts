...
export const pt: TranslationCatalog = {
  ...
  'search.noNearbyResults': 'Não há lugares perto de você; mostro os mais próximos que tenho, mesmo que distantes.',
  ...
  'decision.section.title': 'Para você agora',
  ...
  'decision.why.template': 'Recomendamos porque {list}.',
  'decision.why.fallback': 'Recomendamos como uma boa opção entre as disponíveis agora.',
  'decision.why.openLate': 'fica aberto até tarde',
  'decision.why.mealBreakfast': 'é hora do café da manhã',
  'decision.why.mealLunch': 'é hora do almoço',
  'decision.why.mealDinner': 'é uma boa hora para jantar',
  'decision.why.morning': 'é ótimo para a manhã',
  'decision.why.weekend': 'é uma boa opção para o fim de semana',
  'decision.why.intentMatch': 'combina com o que você procura',
  'decision.why.family': 'é bom para ir em família',
  'decision.why.accessible': 'é acessível',
  'decision.why.parking': 'tem estacionamento',
  'decision.why.verified': 'sua informação está verificada',
