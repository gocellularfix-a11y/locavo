...
export const es = {
  ...
  'rec.whyTitle': 'Por qué se recomienda',
  'rec.stars.a11y': 'Puntuación de recomendación: {stars} de 5',
  'rec.confidence.a11y': 'Confianza de los datos: {label}',
  'rec.confidence.high': 'Confianza alta',
  'rec.confidence.medium': 'Confianza media',
  'rec.confidence.low': 'Confianza baja',
  'rec.confidence.unknown': 'Datos insuficientes',
  'rec.reason.intentMatch': 'Coincide con lo que buscas',
  'rec.reason.openNow': 'Abierto ahora',
  'rec.reason.nearby': 'Muy cerca',
  'rec.reason.parking': 'Con estacionamiento',
  'rec.reason.accessible': 'Acceso para silla de ruedas',
  'rec.reason.family': 'Ideal para familias',
  'rec.reason.highConfidence': 'Datos de alta confianza',
  'rec.reason.official': 'Negocio del directorio oficial',
  'rec.reason.enriched': 'Datos complementados por la comunidad',
  'rec.warn.hoursUnknown': 'Horario no confirmado',
  'rec.warn.closed': 'Cerrado ahora',
  'rec.warn.accessibilityUnknown': 'Accesibilidad sin confirmar',
  'rec.warn.parkingUnknown': 'Estacionamiento sin confirmar',
  'rec.warn.far': 'Un poco lejos',
  'rec.warn.lowConfidence': 'Datos limitados',
  'rec.warn.conflict': 'Fuentes con datos distintos',
  'rec.badge.bestMatch': 'Mejor opción',
  'rec.badge.openNow': 'Abierto ahora',
  'rec.badge.nearby': 'Cerca',
  'rec.badge.family': 'Familiar',
  'rec.badge.accessible': 'Accesible',
  'rec.badge.verified': 'Datos oficiales',
  'rec.badge.enriched': 'Datos ampliados',
  ...
  // Preferencias privadas (V5.4)
  'pref.reason.favorite': 'Uno de tus favoritos',
  'pref.reason.favoriteCategory': 'Coincide con una categoría que te gusta',
  'pref.reason.distance': 'Dentro de tu distancia preferida',
  'pref.reason.accessibility': 'Coincide con tu preferencia de accesibilidad',
  'pref.reason.family': 'Bueno para familias',
  'pref.reason.parking': 'El estacionamiento coincide con tu preferencia',
  'pref.reason.openNow': 'Abierto ahora, como prefieres',
  'pref.reason.previousDirections': 'Ya pediste cómo llegar aquí',
  'pref.badge.favorite': 'Tu favorito',
  'pref.badge.match': 'Según tus preferencias',
  'pref.settings.title': 'Preferencias',
  'pref.settings.privacy': 'Tus preferencias se quedan en este dispositivo.',
  'pref.settings.favoriteCategories': 'Categorías favoritas',
  'pref.settings.reducedCategories': 'Mostrar menos',
  'pref.settings.maxDistance': 'Distancia máxima preferida',
  'pref.settings.distanceAny': 'Cualquier distancia',
  'pref.settings.openNow': 'Preferir lugares abiertos',
  'pref.settings.accessible': 'Preferir acceso para silla de ruedas',
  'pref.settings.family': 'Preferir lugares familiares',
  'pref.settings.parking': 'Preferir con estacionamiento',
  'pref.settings.reset': 'Restablecer preferencias',
  'pref.settings.resetConfirm': '¿Restablecer todas las preferencias? Se borran favoritos, lugares ocultos y ajustes de preferencia en este dispositivo.',
  'pref.action.favorite': 'Agregar a favoritos',
  'pref.action.unfavorite': 'Quitar de favoritos',
  'pref.action.hide': 'Ocultar este lugar',
  'pref.action.unhide': 'Mostrar de nuevo',

  // Intención (V5.5)
  'intent.input.label': '¿Qué necesitas?',
  'intent.input.placeholder': 'Busca algo para…',
  'intent.input.submit': 'Buscar',
  'intent.clear': 'Limpiar',
  'intent.unknown': 'No reconocimos eso. Te muestro tus sugerencias habituales.',
  'intent.ambiguous.title': '¿Quisiste decir?',
  'intent.reason.match': 'Coincide con lo que pediste',
  'intent.reason.openNow': 'Abierto ahora, como pediste',
  'intent.reason.openLate': 'Abierto hasta tarde',
  'intent.reason.nearby': 'Cerca de ti',
  'intent.reason.accessibility': 'Accesible, como pediste',
  'intent.reason.family': 'Bueno para familias',
  'intent.chip.BREAKFAST': 'Desayuno',
  'intent.chip.COFFEE': 'Café',
  'intent.chip.LUNCH': 'Comida',
  'intent.chip.DINNER': 'Cena',
  'intent.chip.NIGHTLIFE': 'Vida nocturna',
  'intent.chip.FAMILY_ACTIVITY': 'Familia',
  ...
  'intent.chip.ENTERTAINMENT': 'Diversión',
  'intent.chip.ACCESSIBLE': 'Accesible',
  'intent.chip.OPEN_NOW': 'Abierto ahora',
  'intent.chip.OPEN_LATE': 'Abierto tarde',
  ...
  'decision.role.MOST_RELIABLE': 'Más confiable',
  'decision.role.BEST_INTENT_FIT': 'Ideal para lo que pediste',
  'decision.role.BEST_PREFERENCE_FIT': 'Según tus preferencias',
  'decision.role.OPEN_NOW': 'Abierto ahora',
  'decision.role.ACCESSIBLE': 'Accesible',
  'decision.role.FAMILY_PICK': 'Para familias',
  'decision.role.ALTERNATIVE': 'Buena alternativa',
  'decision.reason.DECISION_BEST_OVERALL': 'La mejor opción en conjunto ahora mismo',
  'decision.reason.DECISION_CLOSEST': 'La opción más cercana',
  'decision.reason.DECISION_MOST_RELIABLE': 'La evidencia más sólida',
  'decision.reason.DECISION_BEST_INTENT_MATCH': 'La que mejor coincide con lo que pediste',
  'decision.reason.DECISION_BEST_PREFERENCE_MATCH': 'La que mejor coincide con tus preferencias',
  'decision.reason.DECISION_OPEN_NOW': 'Abierto ahora mismo',
  'decision.reason.DECISION_ACCESSIBLE': 'Opción accesible',
  'decision.reason.DECISION_FAMILY_PICK': 'Buena para ir en familia',
  'decision.reason.DECISION_STRONG_ALTERNATIVE': 'Una alternativa sólida',
  'decision.tradeoff.TRADEOFF_FARTHER': 'Un poco más lejos',
  'decision.tradeoff.TRADEOFF_LOWER_CONFIDENCE': 'Menos evidencia',
  'decision.tradeoff.TRADEOFF_WEAKER_INTENT_MATCH': 'Coincide menos con lo que pediste',
  'decision.tradeoff.TRADEOFF_WEAKER_PREFERENCE_MATCH': 'Coincide menos con tus preferencias',
  'decision.tradeoff.TRADEOFF_LIMITED_EVIDENCE': 'Evidencia limitada',
  'decision.tradeoff.TRADEOFF_DIFFERENT_CATEGORY': 'Categoría distinta',
  'decision.compare.open': 'Comparar',
  'decision.compare.close': 'Ocultar comparación',
  'decision.compare.title': 'Comparar opciones',
  'decision.compare.role': 'Elección',
  'decision.compare.distance': 'Distancia',
  'decision.compare.status': 'Estado',
  'decision.compare.category': 'Categoría',
  'decision.compare.confidence': 'Confianza',
  'decision.compare.intent': 'Intención',
  'decision.compare.preference': 'Preferencia',
