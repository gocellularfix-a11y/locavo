...
export const es = {
  ...
  // Acciones seguras (V5.7)
  'place.call': 'Llamar',
  'place.callA11y': 'Llamar a {name}',
  'place.callHint': 'Abre el marcador del teléfono con el número del negocio',
  'place.websiteHint': 'Abre el sitio web del negocio en el navegador',
  'place.actionFailed': 'No se pudo abrir la acción. Inténtalo de nuevo.',
  'place.action.available': 'Disponible',
  'place.action.missing': 'Sin información',
  'place.action.invalidCoords': 'Ubicación no válida para navegar',
  'place.action.invalidPhone': 'Número de teléfono no válido',
  'place.action.invalidUrl': 'Dirección web no válida',
  'place.action.unsupportedScheme': 'Enlace no permitido',
